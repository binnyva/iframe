...
class SqlPager {
	...
	///The current env of the system. Possible values are 'd' = Development Mode, 't' = Testing Mode, 'p' = Production Mode
	public $env = 'dev';
	public $opt = array(
...
function goToPage(page) {
	...
	/**
	 * Shows an error message based on env.
	 */
	function _error($message) {
		if($this->env == 'dev') die($message);
		elseif($this->env == 'test') print($message);
	}
}
